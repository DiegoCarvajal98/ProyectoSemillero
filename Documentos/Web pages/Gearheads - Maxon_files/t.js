...
et_addEvent(
    ...
    },
    {
        "name": "pdf",
        "type": "download",
        "pattern": "^(https?:\\\/\\\/)?(www\\.)?(.*\\.)?(maxongroup\\.com|maxongroup\\.com).+\\.pdf$"
    }
];
...
var et_deliveryHash = "zjZROKFwAYrGVXy5hEjQVOfrv1N0WZ3M";

var cc_autoPageNameRegistration = 'title';
var cc_getParamsWhiteList = [];
ET_Event = new etEvent("S59r6m", et_server);
...
var cc_deltaTime 	= 16117795515099-(new Date().getTime()*10);
...
})();function _etc_start()
{
	...
	etCommerce.etCommerceLoad('S59r6m');
	etCommerce.doPreparedEvents();        et_setupPageExitBeacon('S59r6m');
